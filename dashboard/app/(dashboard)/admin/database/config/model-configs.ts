...
export const MODEL_CONFIGS: Record<string, ModelConfig> = {
    ...
    tabs: [
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            type: "number",
            helpText: "Chilly elixir — heat and fire (same stat)",
            min: 0,
            showIf: (data) => (data.buff as { active?: boolean } | undefined)?.active === true,
          },
          {
      ...
      },
      {
        ...
        fields: [
          ...
          {
            key: "_devBoostTestPanel",
            label: "Test boost (staff)",
            type: "custom",
            component: "DevBoostTestPanel",
            helpText:
              "Turn on to simulate a boost without Discord/TempData. Choose **Boost type** (job + category + effect), set **Boosted by** to “(Dummy booster)” or any name, then save. Scholar + Gathering asks for target village. Does not consume on use — disable when done.",
          },
          {
  ...
  User: {
    ...
    tabs: [
        ...
        fields: [
          {
            ...
            label: "Discord ID",
            type: "text",
            helpText: "Unique Discord ID of the user",
            required: true,
          },
          {
            key: "username",
            label: "Username",
            type: "text",
            helpText: "Discord username / display name",
          },
          {
            key: "timezone",
            label: "Timezone",
            type: "text",
            helpText: "User's timezone (e.g. UTC, America/New_York)",
          },
          {
            key: "tokens",
            label: "Tokens",
            type: "number",
            helpText: "Number of tokens the user has",
            min: 0,
          },
          {
            key: "characterSlot",
            ...
            type: "number",
            helpText: "Number of character slots available",
            min: 0,
          },
          {
            key: "status",
          ...
          {
            key: "blightedcharacter",
            label: "Blighted Character",
            type: "boolean",
            helpText: "Whether the user has a blighted character",
          },
          {
            key: "statusChangedAt",
            label: "Status Changed At",
            type: "date",
            helpText: "When the status was last changed",
          },
          {
            key: "lastMessageTimestamp",
            label: "Last Message Timestamp",
            type: "date",
            helpText: "Timestamp of the last message",
          },
          {
            key: "introPostedAt",
            label: "Intro Posted At",
            type: "date",
            helpText: "When the user posted their intro",
          },
          {
            key: "googleSheetsUrl",
            label: "Google Sheets URL",
            type: "text",
            helpText: "URL to user's Google Sheets (if applicable)",
          },
          {
            key: "tokenTracker",
            label: "Token Tracker",
            type: "text",
            helpText: "URL to token tracker",
          },
          {
            key: "tokensSynced",
            label: "Tokens Synced",
            type: "boolean",
            helpText: "Whether tokens are synced",
          },
        ],
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: "Level",
            type: "number",
            helpText: "Current level",
            min: 1,
          },
          {
            key: "leveling.totalMessages",
            label: "Total Messages",
            type: "number",
            helpText: "Total messages sent",
            min: 0,
          },
          {
            key: "leveling.lastMessageTime",
            label: "Last Message Time",
            type: "date",
            helpText: "Last time user sent a message (for cooldown)",
          },
          {
            key: "leveling.lastExchangedLevel",
            label: "Last Exchanged Level",
            type: "number",
            helpText: "Last level exchanged for tokens",
            min: 0,
          },
          {
            key: "leveling.totalLevelsExchanged",
            label: "Total Levels Exchanged",
            type: "number",
            helpText: "Total levels exchanged for tokens",
            min: 0,
          },
          {
            key: "leveling.hasImportedFromMee6",
            label: "Imported From MEE6",
            type: "boolean",
            helpText: "Whether user has imported from MEE6",
          },
          {
            key: "leveling.importedMee6Level",
            label: "Imported MEE6 Level",
            type: "number",
            helpText: "Level imported from MEE6",
            min: 0,
          },
        ],
      },
      {
        ...
        fields: [
          {
            key: "_questTotalCompleted",
            label: "Total Completed",
            type: "computed",
            helpText: "Bot + Legacy (auto-calculated, read-only)",
            getValue: (data) =>
              (Number((data["quests.bot.completed"] ?? 0)) || 0) +
              (Number((data["quests.legacy.completed"] ?? 0)) || 0),
          },
          {
            key: "_questTotalPending",
            label: "Total Pending",
            type: "computed",
            helpText: "Bot + Legacy pending turn-ins (auto-calculated, read-only)",
            getValue: (data) =>
              (Number((data["quests.bot.pending"] ?? 0)) || 0) +
              (Number((data["quests.legacy.pending"] ?? 0)) || 0),
          },
          {
            key: "quests.bot.completed",
            label: "Bot Quests Completed",
            type: "number",
            helpText: "Quests completed since bot",
            min: 0,
          },
          {
            key: "quests.bot.pending",
            label: "Bot Quests Pending",
            type: "number",
            helpText: "Pending turn-ins (bot)",
            min: 0,
          },
          {
            key: "quests.legacy.completed",
            label: "Legacy Quests Completed",
            type: "number",
            helpText: "Legacy quests imported (pre-bot)",
            min: 0,
          },
          {
            key: "quests.legacy.pending",
            label: "Legacy Quests Pending",
            type: "number",
            helpText: "Pending turn-ins (legacy)",
            min: 0,
          },
          {
            key: "quests.lastCompletionAt",
            label: "Last Completion At",
            type: "date",
            helpText: "When user last completed a quest (YYYY-MM-DD)",
            placeholder: "YYYY-MM-DD",
          },
          {
            key: "quests.turnIns.totalSetsTurnedIn",
            label: "Total Sets Turned In",
            type: "number",
            helpText: "Total sets of 10 turned in for rewards",
            min: 0,
          },
          {
            key: "quests.turnIns.lastTurnedInAt",
            label: "Last Turned In At",
            type: "date",
            helpText: "When user last turned in a set of 10 (YYYY-MM-DD)",
            placeholder: "YYYY-MM-DD",
          },
        ],
      },
      {
        ...
        fields: [
          {
            key: "quests.completions",
            label: "Completion history",
            type: "custom",
            component: "QuestCompletionsField",
            helpText: "Full history of quest completions for this user. Read-only.",
          },
        ],
      },
      {
        ...
        fields: [
          {
            key: "helpWanted.lastCompletion",
            label: "Last Completion (YYYY-MM-DD)",
            type: "text",
            helpText: "Last Help Wanted completion date",
          },
          {
            key: "helpWanted.cooldownUntil",
            label: "Cooldown Until",
            type: "date",
            helpText: "Help Wanted cooldown end",
          },
          {
            key: "helpWanted.totalCompletions",
            label: "Total Completions",
            type: "number",
            helpText: "Total Help Wanted completions (never decreases)",
            min: 0,
          },
          {
            key: "helpWanted.currentCompletions",
            label: "Current Completions",
            type: "number",
            helpText: "Available completions for exchange",
            min: 0,
          },
          {
            key: "helpWanted.lastExchangeAt",
            label: "Last Exchange At",
            type: "date",
            helpText: "When user last exchanged completions",
          },
        ],
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: "Birthday Day",
            type: "number",
            helpText: "Birthday day (1-31)",
            min: 1,
            max: 31,
          },
          {
            key: "birthday.lastBirthdayReward",
            label: "Last Birthday Reward (Year)",
            type: "text",
            helpText: "Last year they received birthday rewards (YYYY)",
          },
          {
            key: "birthday.birthdayDiscountExpiresAt",
            label: "Birthday Discount Expires At",
            type: "date",
            helpText: "When the birthday discount expires",
          },
        ],
      },
      {
        ...
        fields: [
          {
            key: "boostRewards.lastRewardMonth",
            label: "Last Reward Month (YYYY-MM)",
            type: "text",
            helpText: "Last month boost rewards were given",
          },
          {
            key: "boostRewards.totalRewards",
            label: "Total Rewards",
            type: "number",
            helpText: "Total boost rewards received",
            min: 0,
          },
        ],
      },
        ...
        fields: [
          {
            ...
            helpText: "Quadrant data (Q1–Q4): status, blighted, noCamp, hazards, terrain, items, monsters, bossMonsters, special, discoveries, exploredBy, exploredAt, oldMapNumber, oldMapLeadsTo, oldMapLeadConsumed, ruinRestStamina",
          },
        ],
      },
      {
  ...
  Relic: {
    ...
    nameField: "relicId",
    sortField: "relicId",
    filterKeys: ["appraised", "archived", "discoveredBy"],
    tabs: [
      {
        id: "basics",
        label: "Basics",
        ...
        fields: [
          {
            ...
            label: "Relic ID",
            type: "text",
            helpText: "Short display ID (e.g. R473582)",
            required: true,
          },
          {
            key: "name",
          ...
          },
          {
            ...
            label: "Roll Outcome",
            type: "text",
            helpText: "Display title / roll outcome name",
          },
          {
            key: "emoji",
            label: "Emoji",
            type: "text",
            helpText: "Emoji for display (default 🔸)",
          },
          {
            key: "unique",
            label: "Unique",
            type: "boolean",
            helpText: "One-of-a-kind relic",
          },
          {
            key: "duplicateOf",
            label: "Duplicate Of (ObjectId)",
            type: "text",
            helpText: "Reference to original relic if this is a duplicate",
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            label: "Discovered By",
            type: "text",
            helpText: "Character name who discovered (or NPC)",
          },
          {
            key: "characterId",
            label: "Character ID",
            type: "text",
            helpText: "ObjectId of discoverer character (leave empty for NPC)",
          },
          {
            key: "discoveredDate",
            label: "Discovered Date",
            type: "date",
            helpText: "When the relic was discovered",
          },
          {
            key: "locationFound",
            label: "Location Found",
            type: "text",
            helpText: "Location details (quadrant, ruin, etc.)",
          },
          {
            key: "region",
            label: "Region",
            type: "text",
            helpText: "Region for library card (e.g. Eldin)",
          },
          {
            key: "square",
            label: "Square",
            type: "text",
            helpText: "Map square (e.g. D2)",
          },
          {
            key: "quadrant",
            label: "Quadrant",
            type: "text",
            helpText: "Quadrant (e.g. Q3)",
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            label: "Appraised",
            type: "boolean",
            helpText: "Whether the relic has been appraised",
          },
          {
            key: "appraisedBy",
            label: "Appraised By",
            type: "text",
            helpText: "Character or NPC who appraised",
          },
          {
            key: "appraisalDate",
            label: "Appraisal Date",
            type: "date",
            helpText: "When appraisal occurred",
          },
          {
            key: "appraisalDeadline",
            label: "Appraisal Deadline",
            type: "date",
            helpText: "7 days from discovered date",
          },
          {
            key: "artDeadline",
            label: "Art Deadline",
            type: "date",
            helpText: "2 months from appraisal (art submission)",
          },
          {
            key: "appraisalDescription",
            label: "Appraisal Description",
            type: "text",
            rows: 8,
            helpText: "Flavor text or full description revealed during appraisal. Shown on library cards and in relic embeds.",
            placeholder: "Enter the appraisal / flavor text for this relic…",
          },
          {
            key: "npcAppraisal",
            label: "NPC Appraisal",
            type: "boolean",
            helpText: "True if 500 tokens paid for NPC appraisal",
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            label: "Art Submitted",
            type: "boolean",
            helpText: "Whether art has been submitted",
          },
          {
            key: "imageUrl",
            label: "Image URL",
            type: "text",
            helpText: "URL of submitted 1:1 PNG image",
          },
          {
            key: "libraryPositionX",
            label: "Library Position X (%)",
            type: "number",
            helpText: "0–100 from left on library map",
            min: 0,
            max: 100,
          },
          {
            key: "libraryPositionY",
            label: "Library Position Y (%)",
            type: "number",
            helpText: "0–100 from top on library map",
            min: 0,
            max: 100,
          },
          {
            key: "libraryDisplaySize",
            label: "Library Display Size (%)",
            type: "number",
            helpText: "Size of relic image as % of map width (default 8)",
            min: 0,
          },
        ],
      },
        ...
        fields: [
          {
            ...
            label: "Archived",
            type: "boolean",
            helpText: "Archived in the Library",
          },
          {
            key: "deteriorated",
            label: "Deteriorated",
            type: "boolean",
            helpText: "Deteriorated due to late appraisal",
          },
          {
            key: "firstCompletionRewardGiven",
            label: "First Completion Reward Given",
            type: "boolean",
            helpText: "1,000 tokens for first full completion",
          },
          {
            key: "duplicateRewardGiven",
            label: "Duplicate Reward Given",
            type: "boolean",
            helpText: "Reward for turning in duplicate",
          },
        ],
      },
      {
        ...
        fields: [
          {
            ...
            type: "text",
            rows: 5,
            helpText: "Additional lore or description of the relic",
          },
          {
            key: "functionality",
            label: "Functionality",
            type: "text",
            rows: 5,
            helpText: "Relic abilities or functions",
          },
          {
            key: "origins",
            label: "Origins",
            type: "text",
            rows: 5,
            helpText: "Background or origin information",
          },
          {
            key: "uses",
            label: "Uses",
