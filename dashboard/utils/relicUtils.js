...
// Note: Discord notifications removed - dashboard doesn't have Discord client access
  ...
  try {
    ...
    for (const relic of relics) {
      ...
      if (now > appraisalDeadline) {
        ...
        // Log expiration (Discord notifications not available in dashboard)
        console.log(`[relicUtils]: Relic "${relic.name}" expired (discoverer: ${relic.discovererId})`);
      }
    }
  } catch (error) {
