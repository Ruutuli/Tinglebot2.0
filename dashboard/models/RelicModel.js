...
const RelicSchema = new Schema({
  ...
  // ------------------- Library display (archives page) -------------------
  libraryPositionX: { type: Number, default: null },   // Percent 0–100 from left on library map (null = unplaced).
  libraryPositionY: { type: Number, default: null },    // Percent 0–100 from top on library map.
  libraryDisplaySize: { type: Number, default: 8 },   // Size of relic image on map as percent of map width (default 8).
