...
/**
 * Blupee event quests: rupee count in TempData (blupeeModule) is authoritative for completion;
 * participant.successfulRolls may lag if questCtx was missing on catch.
 */
...
// ------------------- Export Quest Model -------------------
const QuestExported = mongoose.models.Quest || mongoose.model('Quest', questSchema);
module.exports = QuestExported;
