...
// Note: Discord embeds are not used in dashboard context
...
const recoverHearts = async (characterId, hearts, healerId = null) => {
  try {
    ...
    if (modCharacter) {
      ...
      return { message: `❤️ Mod character - no heart recovery needed` };
    }
    ...
    return { message: `❤️ +${hearts} hearts recovered` };
  } catch (error) {
    handleError(error, 'characterStatsModule.js', {
...
const recoverStamina = async (characterId, stamina) => {
  try {
    ...
    if (modCharacter) {
      ...
      return { message: `🟩 Mod character - no stamina recovery needed` };
    }
    ...
    return { message: `🟩 +${stamina} stamina recovered` };
  } catch (error) {
    handleError(error, 'characterStatsModule.js', {
...
const useHearts = async (characterId, hearts, context = {}) => {
  try {
    ...
    if (modCharacter) {
      ...
      return { message: `❤️ Mod character - no hearts lost` };
    }
    ...
    return { message: `❤️ -${hearts} hearts used` };
  } catch (error) {
...
const healKoCharacter = async (characterId, healerId = null) => {
  try {
    ...
    if (modCharacter) {
      ...
      return { message: `❤️ Mod character - no KO healing needed` };
    }
    ...
    await Character.updateOne({ _id: characterId }, { $set: updateData });
    return { message: `❤️ ${character.name} has been revived.` };
  } catch (error) {
    handleError(error, 'characterStatsModule.js', {
