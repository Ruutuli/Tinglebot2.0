...
const Monster = require('../models/MonsterModel.js');
const HelpWantedQuest = require('../models/HelpWantedQuestModel.js');
const GeneralItem = require('../models/GeneralItemModel.js');
