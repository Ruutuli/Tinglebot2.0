...
Exploration is live. All persistence (hearts, stamina, items, map, grottos, Spirit Orbs, wave/raid loot) is enabled. The former exploration testing mode and `bot/utils/explorationTestingConfig.js` have been removed.
