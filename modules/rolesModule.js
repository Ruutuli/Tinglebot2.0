...
const roles = {
    ...
    Jobs: [
      ...
      { name: 'Job: Herbalist', color: '#5e626e' },
      { name: 'Job: Hunter', color: '#5e626e' },
      { name: 'Job: Merchant', color: '#5e626e' },
      { name: 'Job: Mercenary', color: '#5e626e' },
      { name: 'Job: Priest', color: '#5e626e' },
      { name: 'Job: Scout', color: '#5e626e' },
      { name: 'Job: Shopkeeper', color: '#5e626e' },
