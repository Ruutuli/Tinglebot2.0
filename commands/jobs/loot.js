...
const { activateJobVoucher,validateJobVoucher, fetchJobVoucherItem, deactivateJobVoucher } = require('../../modules/jobVoucherModule.js'); // Importing jobVoucherModule

// Modules - RNG Logic
const {  createWeightedItemList,  getMonsterEncounterFromList,  getMonstersByCriteria,  calculateFinalValue,  getRandomBloodMoonEncounter,} = require('../../modules/rngModule.js');
...
const {
  ...
  getNoItemsFoundMessage,  getFailedToDefeatMessage,  getNoEncounterMessage,  generateAttackBuffMessage,} = require('../../modules/flavorTextModule.js');
...
// Character Stats
const {
  updateCurrentHearts,  handleKO,  useHearts,} = require('../../modules/characterStatsModule.js');
