...
// Models
const Character = require('../../models/CharacterModel.js'); // Character model

// Embeds
const { createCharacterEmbed } = require('../../embeds/embeds.js'); // Embeds for character display

// Database
const { connectToTinglebot } = require('../../database/connection.js'); // Database connection
const { createCharacterInventory,   deleteCharacterInventoryCollection,   fetchCharacterById,   fetchCharacterByNameAndUserId,   updateCharacterById } = require('../../database/characterService.js'); // Character-related database services

// Handlers
const { handleAutocomplete } = require('../../handlers/autocompleteHandler.js'); // Autocomplete handler

// Modules
const { getGeneralJobsPage,   getJobsByCategory } = require('../../modules/jobsModule.js'); // Jobs handling
const { getVillageColorByName } = require('../../modules/locationsModule.js'); // Village color utility
const { isValidRace } = require('../../modules/raceModule.js'); // Race validation utility
const { updateHearts,   updateStamina } = require('../../modules/characterStatsModule.js'); // Character stats updates
const { capitalizeFirstLetter } = require('../../modules/formattingModule.js'); // Formatting utility
const { roles } = require('../../modules/rolesModule.js');

const { handleError } = require('../../utils/globalErrorHandler.js');
// Utilities
const { canChangeJob,   canChangeVillage,   isUniqueCharacterName,   convertCmToFeetInches } = require('../../utils/validation.js'); // Validation utilities
