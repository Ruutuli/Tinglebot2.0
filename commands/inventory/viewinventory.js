...
const { fetchCharacterById, getCharacterInventoryCollection } = require('../../database/characterService.js');
const { connectToInventories } = require('../../database/connection.js');
