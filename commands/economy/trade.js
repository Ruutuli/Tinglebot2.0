...
const { fetchCharacterByNameAndUserId, fetchCharacterByName, getCharacterInventoryCollection } = require('../../database/characterService.js');


// ------------------- Modules -------------------
// Custom modules for creating embed messages and handling autocomplete.
const { createTradeEmbed } = require('../../embeds/embeds.js');
const { handleTradeAutocomplete } = require('../../handlers/autocompleteHandler.js');
