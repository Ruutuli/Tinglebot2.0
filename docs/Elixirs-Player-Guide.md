...
| **Faster travel** (time **halved**, min 1 day)         | **Hasty** — **1 / 2 / 3** charges by tier when a leg shortens |
...
| **Hasty**   | Travel duration **halved** (min **1** day)                                                                       | —                                                           | **Travel** — **1 / 2 / 3** charges (Basic / Mid / High); one charge when a leg is shortened                                                      | **Explore:** **×1.5** weight for **Quadrant explored** (roller has Hasty)                   |
...
- **Hasty —** **Travel time** is **halved** (min **1** day per leg). **1 / 2 / 3** **charges** per bottle (Basic / Mid / High); a charge is used when a leg is actually shortened. **Explore:** **“Quadrant explored”** outcome weight **×1.5** for whoever **rolls** with Hasty — helps parties get the prompt so they can **Move**.
