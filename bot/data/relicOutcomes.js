// ============================================================================
// SINGLE SOURCE for relic data. Must match docs/Relics.md exactly.
// - 1 = unique (only one in world): weight 1, unique: true
// - Unlimited = non-unique: weight 3, unique: false
// - TBD = treated as Unlimited: weight 3, unique: false
// - Translation Scrolls 26 = "Translation Scrolls" outcome is unlimited;
//   "Translation Scroll Volume 01" through "26" are each unique (1).
// When a relic is appraised, the text shown is from RELIC_APPRAISAL_TEXT below (same as doc).
// ============================================================================

/**
 * Relic outcomes: name, short description (for reveal), weight, unique.
 * Order matches the confirmed table (docs/Relics.md).
 */
const RELIC_OUTCOMES = [
  { name: "Ancient Sheikah Orb", description: "A mysterious artifact of ancient Sheikah origin, renowned for its enigmatic properties and intricate design. Unlocks hidden realms within the Inariko library.", weight: 1, unique: true },
  ...
  { name: "Ancient Zonai Bottle", description: "A relic of the mysterious Zonai civilization, exudes an air of enigma with its intricate design and the verdant hue of its contents.", weight: 3, unique: false },
  { name: "Ancient Zonai Dragon Idol", description: "A majestic relic from the enigmatic Zonai civilization, crafted with exquisite detail and reverence. Carved from jade, depicting a powerful dragon.", weight: 3, unique: false },
  { name: "Ancient Zonai Owl Statue", description: "A testament to the craftsmanship and spiritual reverence of the long-lost Zonai civilization. Carved from stone, depicting an owl with outstretched wings.", weight: 3, unique: false },
  { name: "Ancient Zonai Tapestry", description: "A captivating relic that weaves together the history and mystique of the long-lost Zonai civilization.", weight: 1, unique: true },
  { name: "Blessed Hourglass", description: "A rare and potent artifact, imbued with ancient magic and revered for its ability to manipulate the flow of time in the face of blight.", weight: 3, unique: false },
  { name: "Blight Candle", description: "A unique artifact with the remarkable ability to sense and repel blight. Its wax holds a subtle luminescence, flickering with an otherworldly glow when danger approaches.", weight: 3, unique: false },
  { name: "Blight Knight - Chest Plate", description: "The Blight Knight Chest Plate, forged to combat darkness, is a cursed relic adorned with ominous runes. Offering formidable protection, it ensnares wearers in a thirst for battle and vengeance.", weight: 3, unique: false },
  { name: "Blight Knight - Faulds", description: "The Blight Knight Faulds, a vital piece of the infamous Blight Knight armor set, is tainted by the very darkness it seeks to combat.", weight: 3, unique: false },
  { name: "Blight Knight - Helmet", description: "The Blight Knight Helmet, forged in the crucible of ancient strife, is both a symbol of protection and a conduit for corruption. Despite its malevolent influence, the allure of its power persists.", weight: 3, unique: false },
  { name: "Blight Knight - Left Arm", description: "The Blight Knight Left Arm, a relic shrouded in ancient darkness, offers unparalleled strength and resilience, but at a dire cost.", weight: 3, unique: false },
  { name: "Blight Knight - Left Leg", description: "The Blight Knight Left Leg, a relic veiled in ancient shadows, grants unmatched agility and endurance, yet at a profound price.", weight: 3, unique: false },
  { name: "Blight Knight - Right Arm", description: "The Blight Knight Right Arm, a dread artifact from a forgotten era, bestows unparalleled strength and prowess upon its bearer, but at a perilous cost.", weight: 3, unique: false },
  { name: "Blight Knight - Right Leg", description: "The Blight Knight Right Leg, a relic steeped in ancient malevolence, grants unmatched speed and resilience to its bearer, albeit with a sinister twist.", weight: 3, unique: false },
  { name: "Blighted Dragon Parts", description: "Mysterious remnants of unknown origin within the realm of Hyrule. These artifacts, ranging from scales to talons, emanate an unsettling aura.", weight: 3, unique: false },
  { name: "Book Of Mudora", description: "An ancient tome of unparalleled knowledge, shrouded in mystery and revered by scholars throughout the ages. Bound in weathered leather and adorned with intricate sigils.", weight: 1, unique: true },
  { name: "Lens Of Truth", description: "A mystical artifact of unparalleled clarity, crafted with precision and imbued with ancient magic. Bestows the ability to peer beyond illusions and deceptions.", weight: 3, unique: false },
  { name: "Moon Pearl", description: "A radiant orb of celestial essence, shimmering with an ethereal glow. Grants its bearer immunity against the corrupting influence of the blight.", weight: 1, unique: true },
  { name: "Old Key", description: "Weathered by the passage of time, holds within its rusted grooves the promise of unlocking mysteries long forgotten.", weight: 3, unique: false },
  { name: "Poe's Lantern", description: "A mysterious artifact originating from the depths of Hyrule's blight-filled crypts, exudes an otherworldly radiance that defies the darkness surrounding it.", weight: 3, unique: false },
  { name: "Power Bracelet", description: "A relic of formidable might, bears the legacy of a previous oracle of power within its ancient design. Forged by the skilled hands of Goron blacksmiths.", weight: 1, unique: true },
  { name: "Shard of Agony", description: "A curious artifact shrouded in mystery, appears as a translucent crystal fragment pulsating with an ominous energy. Said to detect hidden secrets and concealed passages.", weight: 3, unique: false },
  { name: "Talisman", description: "A potent artifact associated with an ancient and enigmatic clan that once held ties to the Sheikah. Crafted with dark magic and imbued with sinister intentions.", weight: 3, unique: false },
  { name: "Tattered Diary", description: "A collection of weathered journals discovered scattered across the outskirts of Hyrule, bearing witness to a mysterious life shrouded in enigma.", weight: 3, unique: false },
  { name: "The Moon's Tear", description: "A celestial artifact revered by the Twili, shimmers with an ethereal glow. Grants its bearer immunity against the harsh influence of the sun.", weight: 3, unique: false },
  { name: "The Tainted Idol", description: "A relic steeped in darkness and despair, emanates an aura of malevolence. Carved from obsidian and adorned with sinister glyphs.", weight: 3, unique: false },
  { name: "Wooden Totem", description: "A rustic artifact hewn from the ancient trees of the Kokiri Forest, carved with intricate patterns and adorned with verdant foliage.", weight: 3, unique: false },
  { name: "Translation Scrolls", description: "A collection of ancient parchments inscribed with mystical runes, serves as a key to unlocking the secrets hidden within the Book of Mudora.", weight: 3, unique: false },
  ...
  { name: "Translation Scroll Volume 01", description: "This scroll is imbued with ancient magic that facilitates the translation of one letter into another within the Book of Mudora's cryptic language. When the letter \"Y\" is encountered, it shall reveal the true meaning of \"A\".", weight: 1, unique: true },
  { name: "Translation Scroll Volume 02", description: "Bearing the power to transmute the letter \"P\" into the symbol \"B\" within the sacred text of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 03", description: "With the utterance of the letter \"L\", this scroll reveals its transformative magic, transcribing it into the venerable symbol \"C\" within the pages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 04", description: "Marked with the sigil of \"T\", this scroll possesses the mystical power to metamorphose it into the revered symbol \"D\" within the sacred texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 05", description: "Bearing the letter \"A\" as its key, this scroll illuminates the path to enlightenment by transposing it into the esteemed symbol \"E\" within the pages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 06", description: "Etched with the glyph of \"V\", this scroll holds the power to unveil the truth hidden within the ancient tomes by transforming it into the sacred symbol \"F\".", weight: 1, unique: true },
  { name: "Translation Scroll Volume 07", description: "Bearing the enigmatic letter \"K\", this scroll possesses the arcane ability to transmute it into the revered symbol \"G\" within the hallowed pages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 08", description: "Emblazoned with the sacred mark of \"R\", this scroll holds the power to transform it into the esteemed symbol \"H\" within the venerable texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 09", description: "Carrying the letter \"E\" as its key, this scroll unveils the hidden truths of the ancient tomes by transposing it into the revered symbol \"I\" within the pages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 10", description: "Adorned with the symbol \"Z\", this scroll possesses the mystical potency to metamorphose it into the esteemed symbol \"J\" within the sacred texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 11", description: "Bearing the mark of \"G\", this scroll holds the power to transmute it into the revered symbol \"K\" within the hallowed passages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 12", description: "Etched with the glyph \"M\", this scroll embodies the mystical ability to transmute it into the esteemed symbol \"L\" within the venerable pages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 13", description: "Imbued with the symbol \"S\", this scroll possesses the arcane energy to transcribe it into the revered symbol \"M\" within the ancient texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 14", description: "Marked with the enigmatic sigil \"H\", this scroll holds the power to transform it into the esteemed symbol \"N\" within the hallowed passages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 15", description: "Bearing the symbol \"U\", this scroll embodies the mystical potency to transcribe it into the revered symbol \"O\" within the sacred texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 16", description: "Adorned with the symbol \"B\", this scroll possesses the arcane essence to metamorphose it into the esteemed symbol \"P\" within the ancient manuscripts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 17", description: "Emblazoned with the mark \"X\", this scroll holds the power to transmute it into the revered symbol \"Q\" within the hallowed passages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 18", description: "Carrying the enigmatic symbol \"N\", this scroll embodies the mystical energy to transcribe it into the esteemed symbol \"R\" within the sacred texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 19", description: "Etched with the glyph \"C\", this scroll possesses the arcane potential to transform it into the esteemed symbol \"S\" within the ancient manuscripts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 20", description: "Bearing the mark \"D\", this scroll holds the power to transmute it into the revered symbol \"T\" within the hallowed passages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 21", description: "Carrying the symbol \"I\", this scroll embodies the mystical essence to transcribe it into the esteemed symbol \"U\" within the sacred texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 22", description: "Adorned with the symbol \"J\", this scroll possesses the arcane power to metamorphose it into the esteemed symbol \"V\" within the ancient manuscripts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 23", description: "Emblazoned with the mark \"F\", this scroll holds the power to transmute it into the revered symbol \"W\" within the hallowed passages of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 24", description: "Carrying the enigmatic symbol \"Q\", this scroll embodies the mystical energy to transcribe it into the esteemed symbol \"X\" within the sacred texts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 25", description: "Marked with the symbol \"O\", this scroll possesses the arcane essence to transmute it into the esteemed symbol \"Y\" within the ancient manuscripts of the Book of Mudora.", weight: 1, unique: true },
  { name: "Translation Scroll Volume 26", description: "Bearing the mark \"W\", this scroll holds the power to transmute it into the revered symbol \"Z\" within the hallowed passages of the Book of Mudora.", weight: 1, unique: true },
];

/** Legacy spellings -> canonical name (docs/Relics.md uses "Lens Of Truth"). Keep in sync with relicUtils.js RELIC_NAME_ALIASES. */
const NAME_ALIASES = { 'Lens of Truth': 'Lens Of Truth', 'Lense Of Truth': 'Lens Of Truth' };

/** Full appraisal text for each relic — must match docs/Relics.md. Used when a relic is appraised (same text everywhere). Discord embed limit 4096; truncated at 4000 if over. */
...
**Uses:** A character may activate the Blessed Hourglass in a village (via the relic command). Once activated, all inhabitants of that village need not roll for blight for one week, offering temporary relief from the affliction's effects.`,
...
**Uses:** No mechanical use in the bot. Scholars speculate that the green liquid within may grant extraordinary abilities to those who ingest it, yet they strongly advise against any such attempt. The relic is valued for the archives.`,
...
**Uses:** No mechanical use in the bot. Scholars and historians study the Ancient Zonai Dragon Idol to unravel the mysteries of the lost Zonai civilization; it is valued for the archives.`,
...
**Uses:** No mechanical use in the bot. The statue was once displayed by tribal elders as a symbol of wisdom and guidance; it is valued for the archives.`,
...
**Origins:** The origins of the Blight Candle are shrouded in mystery, with some tales attributing its creation to ancient guardians or prophetic seers who sought to combat the spread of blight. Legends suggest that it was forged during a time of great turmoil, crafted by skilled artisans who imbued it with the essence of purity to counteract the darkness of blight.

**Uses:** When the party explores through blighted areas, the Blight Candle halves the chance of contracting blight and consumes one use per exposure. When exploring ruins, if a character would find blight, the candle may repel it, consuming one use. The candle has three uses; once all are spent it burns out and loses its abilities.`,
...
**Uses:** No mechanical use in the bot. Blighted Dragon parts are subjects of arcane research; their ominous hues and unsettling aura suggest a connection to dark forces, sparking curiosity about their potential properties.`,

  'Lens Of Truth': `**__Lens Of Truth__**
...
**Uses:** In maze-type grottos, a party carrying the Lens of Truth may choose to bypass the maze entirely, receiving a Spirit Orb for each party member but forgoing maze chests and encounters.`,
...
**Uses:** The bearer of the Moon Pearl is immune to blight: no blight roll is required when they are due, and blight is not applied to them. The pearl works passively; no activation is needed.`,
...
**Uses:** No mechanical use in the bot is known; scholars deem it worth keeping and collecting in case of future uses.`,
...
**Uses:** Scholars and adventurers believe Poe's Lantern may one day allow course corrections or second chances within grottos; no such power has been confirmed in practice. It is kept for its lore and in hope of future discovery.`,
...
**Uses:** Legend attributes to the Shard the ability to detect hidden secrets and concealed passages; when activated it is said to emit faint vibrations and a soft hum. No mechanical use in the bot has been confirmed.`,
...
**Uses:** These talismans hold no active power in the bot. They are kept for study regarding their significance and potential latent abilities.`,
...
**Uses:** No mechanical use in the bot. Lore holds that the Tainted Idol exerts a corrupting influence, enticing the unwary with promises of power; it is kept for study and the archives.`,
...
**Uses:** No mechanical use in the bot. As a manifestation of the Kokiri's connection to the forest, the totem is said to facilitate communion with woodland spirits; it is valued for the archives.`,

  'Ancient Sheikah Orb': `**__Ancient Sheikah Orb__**
...
**Uses:** The Orb acts as a key to unlock a concealed chamber nestled within the depths of the Inariko Library. Within its confines lie a trove of ancient relics and manuscripts. Recognizing its significance, the scholars of the library opt to designate this chamber as a repository for any forthcoming discoveries.`,
  ...
  'Ancient Tablet': `**__Ancient Tablet__**
...
**Uses:** As of this time, the Ancient Tablet serves as a cultural artifact.`,
  ...
  'Ancient Tablet of Courage': `**__Ancient Tablet of Courage__**
...
**Uses:** Revered as a symbol of bravery and heroism, the Ancient Tablet of Courage serves as a rallying point for adventurers and defenders of justice. Its teachings echo across time and space, reminding all who encounter it of the enduring power of the human spirit.`,
  ...
  'Ancient Tablet of Power': `**__Ancient Tablet of Power__**
...
**Uses:** Revered as a symbol of resilience and fortitude, the Ancient Tablet of Power serves as a source of inspiration for warriors and adventurers alike. Its teachings resonate across generations, reminding all who encounter it of the boundless potential that lies within.`,
  ...
  'Ancient Tablet of Wisdom': `**__Ancient Tablet of Wisdom__**
...
**Uses:** Revered as a symbol of knowledge and enlightenment, the Ancient Tablet of Wisdom serves as a source of inspiration for scholars and seekers of truth. Its teachings transcend time and space, offering guidance to all who seek to unravel the mysteries of existence.`,
  ...
  'Ancient Zonai Tapestry': `**__Ancient Zonai Tapestry__**
...
**Uses:** It was believed this tapestry possessed mystical properties that granted insight into the workings of destiny and the passage of time. Seekers of knowledge and foresight consulted the tapestry, interpreting its patterns and symbols to gain glimpses of future events or understand the underlying forces shaping their lives.`,
  ...
  'Blight Knight - Chest Plate': `**__Blight Knight - Chest Plate__**
...
The Blight Knight Chest Plate, forged to combat darkness, is a cursed relic adorned with ominous runes. Offering formidable protection, it ensnares wearers in a thirst for battle and vengeance, their souls consumed by the Blight's corruption.`,
  ...
  'Blight Knight - Faulds': `**__Blight Knight - Faulds__**
...
The Blight Knight Faulds, a vital piece of the infamous Blight Knight armor set, is tainted by the very darkness it seeks to combat. Crafted with ancient symbols and overlapping plates, it exudes an aura of corruption, betraying its sinister origins.`,
  ...
  'Blight Knight - Helmet': `**__Blight Knight - Helmet__**
...
The Blight Knight Helmet, forged in the crucible of ancient strife, is both a symbol of protection and a conduit for corruption. Its sinister design offers formidable defense, yet those who don it find themselves drawn into a cycle of violence, their minds clouded by the darkness it harbors. Despite its malevolent influence, the allure of its power persists for those willing to embrace the darkness it embodies.`,
  ...
  'Blight Knight - Left Arm': `**__Blight Knight - Left Arm__**
...
The Blight Knight Left Arm, a relic shrouded in ancient darkness, serves as a grim reminder of a bygone era of strife. Crafted with sinister intent, this corrupted limb offers unparalleled strength and resilience, but at a dire cost. Those who don it find themselves consumed by the Blight's malevolence, their actions guided by its twisted will.`,
  ...
  'Blight Knight - Left Leg': `**__Blight Knight - Left Leg__**
...
The Blight Knight Right Leg, a relic steeped in ancient malevolence, stands as a grim testament to an era of darkness. Molded with sinister intent, this corrupted limb grants unmatched speed and resilience to its bearer, albeit with a sinister twist. Those who dare to don it find themselves ensnared by the Blight's influence, their movements dictated by its ominous will. Despite the inherent peril, its allure persists for those brave enough to court the shadows it embodies.`,
  ...
  'Book Of Mudora': `**__Book Of Mudora__**
...
**Functionality:** Unlocking the wisdom contained within the Book of Mudora requires more than mere literacy—it demands the aid of translation scrolls. These scrolls, infused with ancient magic, are essential tools for deciphering the cryptic language that fills the tome's pages. Once translated, the knowledge within ranges from lost histories and arcane rituals to enigmatic prophecies, offering insights into realms both mundane and mystical.
...
**Uses:** Within its pages lie spells, rituals, and incantations of great power, allowing those who study its contents to delve into the mysteries of magic and the arcane arts. Reading this tome unlocks the mystery to magic in the realm of Hyrule.`,
  ...
  'Power Bracelet': `**__Power Bracelet__**
...
**Uses:** As a relic once owned by an oracle of power, the Power Bracelet carries a legacy of strength and authority. It hints at an untold story from Oracles past.`,
  ...
  'Tattered Diary': `**__Tattered Diary__**
...
**Uses:** The introspective nature of the Tattered Diary Entries invites readers to delve into the psyche of their unnamed author, exploring themes of solitude, identity, and existential contemplation. Psychologists and literary scholars analyze the author's musings and reflections, seeking to uncover the motivations and inner turmoil that shape their experiences and worldview. It also leads scholars to wonder who the owner of these entries is, as they speak of experiences not within the known three villages.`,
  ...
  "The Moon's Tear": `**__The Moon's Tear__**
...
Others may fear what I can do, but I am not afraid. I will wield this power to bring about change, to mold Hyrule according to my will. The voice spoke the truth. I am destined for greatness, and I will not be deterred.`,
  ...
  'Translation Scroll Volume 01': `**__Translation Scroll Volume 01__**
...
**Description:** This scroll is imbued with ancient magic that facilitates the translation of one letter into another within the Book of Mudora's cryptic language. When the letter "Y" is encountered, it shall reveal the true meaning of "A", unraveling the mysteries hidden within the tome's pages.`,
  'Translation Scroll Volume 02': `**__Translation Scroll Volume 02__**
...
**Description:** Bearing the power to transmute the letter "P" into the symbol "B" within the sacred text of the Book of Mudora, this scroll serves as a key to unlocking the wisdom held within its pages. Through its enchantment, seekers of knowledge may decode the secrets concealed by the ancient sages.`,
  'Translation Scroll Volume 03': `**__Translation Scroll Volume 03__**
...
**Description:** With the utterance of the letter "L", this scroll reveals its transformative magic, transcribing it into the venerable symbol "C" within the pages of the Book of Mudora. Through its guidance, the barriers of language are breached, granting access to the profound wisdom enshrined within.`,
  'Translation Scroll Volume 04': `**__Translation Scroll Volume 04__**
...
**Description:** Marked with the sigil of "T", this scroll possesses the mystical power to metamorphose it into the revered symbol "D" within the sacred texts of the Book of Mudora. Its arcane enchantment paves the way for seekers to navigate the intricate passages of ancient knowledge, unlocking the mysteries veiled by time.`,
  'Translation Scroll Volume 05': `**__Translation Scroll Volume 05__**
...
**Description:** Bearing the letter "A" as its key, this scroll illuminates the path to enlightenment by transposing it into the esteemed symbol "E" within the pages of the Book of Mudora. Through its guidance, the seeker is granted access to the profound insights concealed within the depths of the tome.`,
  'Translation Scroll Volume 06': `**__Translation Scroll Volume 06__**
...
**Description:** Etched with the glyph of "V", this scroll holds the power to unveil the truth hidden within the ancient tomes by transforming it into the sacred symbol "F". With each revelation, the seeker's journey into the realm of knowledge is further illuminated, guided by the ancient wisdom contained within.`,
  'Translation Scroll Volume 07': `**__Translation Scroll Volume 07__**
...
**Description:** Bearing the enigmatic letter "K," this scroll possesses the arcane ability to transmute it into the revered symbol "G" within the hallowed pages of the Book of Mudora. As the seeker embarks on their quest for enlightenment, this scroll serves as a beacon, guiding them through the labyrinthine corridors of ancient wisdom.`,
  'Translation Scroll Volume 08': `**__Translation Scroll Volume 08__**
...
**Description:** Emblazoned with the sacred mark of "R," this scroll holds the power to transform it into the esteemed symbol "H" within the venerable texts of the Book of Mudora. With each revelation, the seeker's understanding is deepened, as they unlock the secrets concealed within the depths of time.`,
  'Translation Scroll Volume 09': `**__Translation Scroll Volume 09__**
...
**Description:** Carrying the letter "E" as its key, this scroll unveils the hidden truths of the ancient tomes by transposing it into the revered symbol "I" within the pages of the Book of Mudora. Through its guidance, the seeker is initiated into the mysteries of the ages, as they delve deeper into the labyrinth of knowledge.`,
  'Translation Scroll Volume 10': `**__Translation Scroll Volume 10__**
...
**Description:** Adorned with the symbol "Z," this scroll possesses the mystical potency to metamorphose it into the esteemed symbol "J" within the sacred texts of the Book of Mudora. Through its enchantment, seekers are bestowed with the key to unlock the arcane wisdom concealed within the tome's ancient pages.`,
  'Translation Scroll Volume 11': `**__Translation Scroll Volume 11__**
...
**Description:** Bearing the mark of "G," this scroll holds the power to transmute it into the revered symbol "K" within the hallowed passages of the Book of Mudora. As seekers embark on their quest for enlightenment, this scroll serves as a guiding light, illuminating the path to ancient wisdom.`,
  'Translation Scroll Volume 12': `**__Translation Scroll Volume 12__**
...
**Description:** Etched with the glyph "M," this scroll embodies the mystical ability to transmute it into the esteemed symbol "L" within the venerable pages of the Book of Mudora. Through its guidance, seekers unravel the enigmatic language of the ancients, unlocking the secrets concealed within the tome's sacred texts.`,
  'Translation Scroll Volume 13': `**__Translation Scroll Volume 13__**
...
**Description:** Imbued with the symbol "S," this scroll possesses the arcane energy to transcribe it into the revered symbol "M" within the ancient texts of the Book of Mudora. As seekers delve into its pages, this scroll serves as a conduit, channeling the wisdom of the ages to those who dare to unlock its secrets.`,
  'Translation Scroll Volume 14': `**__Translation Scroll Volume 14__**
...
**Description:** Marked with the enigmatic sigil "H," this scroll holds the power to transform it into the esteemed symbol "N" within the hallowed passages of the Book of Mudora. Through its guidance, seekers navigate the labyrinthine corridors of ancient knowledge, uncovering the hidden truths that lie within.`,
  'Translation Scroll Volume 15': `**__Translation Scroll Volume 15__**
...
**Description:** Bearing the symbol "U," this scroll embodies the mystical potency to transcribe it into the revered symbol "O" within the sacred texts of the Book of Mudora. As seekers embark on their quest for enlightenment, this scroll serves as a beacon, guiding them through the depths of ancient wisdom.`,
  'Translation Scroll Volume 16': `**__Translation Scroll Volume 16__**
...
**Description:** Adorned with the symbol "B," this scroll possesses the arcane essence to metamorphose it into the esteemed symbol "P" within the ancient manuscripts of the Book of Mudora. As seekers immerse themselves in its teachings, this scroll acts as a conduit, unlocking the profound wisdom hidden within the tome's cryptic pages.`,
  'Translation Scroll Volume 17': `**__Translation Scroll Volume 17__**
...
**Description:** Emblazoned with the mark "X," this scroll holds the power to transmute it into the revered symbol "Q" within the hallowed passages of the Book of Mudora. Through its guidance, seekers traverse the intricate web of ancient knowledge, deciphering the mysteries that have eluded scholars for centuries.`,
  'Translation Scroll Volume 18': `**__Translation Scroll Volume 18__**
...
**Description:** Carrying the enigmatic symbol "N," this scroll embodies the mystical energy to transcribe it into the esteemed symbol "R" within the sacred texts of the Book of Mudora. With each revelation, seekers deepen their understanding, unraveling the secrets veiled by the passage of time.`,
  'Translation Scroll Volume 19': `**__Translation Scroll Volume 19__**
...
**Description:** Etched with the glyph "C," this scroll possesses the arcane potential to transform it into the esteemed symbol "S" within the ancient manuscripts of the Book of Mudora. As seekers embark on their journey of discovery, this scroll serves as a conduit, revealing the hidden truths encoded within the tome's enigmatic pages.`,
  'Translation Scroll Volume 20': `**__Translation Scroll Volume 20__**
...
**Description:** Bearing the mark "D," this scroll holds the power to transmute it into the revered symbol "T" within the hallowed passages of the Book of Mudora. Through its guidance, seekers unlock the ancient wisdom preserved within the tome, gaining insight into the mysteries of the cosmos.`,
  'Translation Scroll Volume 21': `**__Translation Scroll Volume 21__**
...
**Description:** Carrying the symbol "I," this scroll embodies the mystical essence to transcribe it into the esteemed symbol "U" within the sacred texts of the Book of Mudora. With each revelation, seekers transcend the limitations of mortal understanding, tapping into the universal truths concealed within the tome's cryptic pages.`,
  'Translation Scroll Volume 22': `**__Translation Scroll Volume 22__**
...
**Description:** Adorned with the symbol "J," this scroll possesses the arcane power to metamorphose it into the esteemed symbol "V" within the ancient manuscripts of the Book of Mudora. As seekers delve into its teachings, this scroll acts as a key, unlocking the profound secrets hidden within the tome's enigmatic passages.`,
  'Translation Scroll Volume 23': `**__Translation Scroll Volume 23__**
...
**Description:** Emblazoned with the mark "F," this scroll holds the power to transmute it into the revered symbol "W" within the hallowed passages of the Book of Mudora. Through its guidance, seekers navigate the intricate tapestry of ancient knowledge, unraveling the mysteries that lie at the heart of existence.`,
  'Translation Scroll Volume 24': `**__Translation Scroll Volume 24__**
...
**Description:** Carrying the enigmatic symbol "Q," this scroll embodies the mystical energy to transcribe it into the esteemed symbol "X" within the sacred texts of the Book of Mudora. With each revelation, seekers penetrate the veil of illusion, gaining insight into the hidden truths that govern the universe.`,
  'Translation Scroll Volume 25': `**__Translation Scroll Volume 25__**
...
**Description:** Marked with the symbol "O," this scroll possesses the arcane essence to transmute it into the esteemed symbol "Y" within the ancient manuscripts of the Book of Mudora. As seekers immerse themselves in its teachings, this scroll acts as a conduit, revealing the profound insights hidden within the tome's cryptic pages.`,
  'Translation Scroll Volume 26': `**__Translation Scroll Volume 26__**
...
/**
 * Returns the full appraisal text for a relic (same as docs/Relics.md).
 * Used in appraisal embeds and dashboard. Caller falls back to outcome description if null.
 * @param {string} relicName - Name from RELIC_OUTCOMES
 * @returns {string|null}
 */
...
module.exports = { RELIC_OUTCOMES, getAppraisalText, RELIC_APPRAISAL_TEXT };
