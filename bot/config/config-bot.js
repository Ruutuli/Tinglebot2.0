...
const fs = require('fs');
// Try bot error handler first, fallback to dashboard if not found
let handleError;
try {
  handleError = require('../utils/globalErrorHandler').handleError;
} catch (e) {
  try {
    handleError = require('../../Tinglebot Dashboard/utils/globalErrorHandler').handleError;
  } catch (e2) {
