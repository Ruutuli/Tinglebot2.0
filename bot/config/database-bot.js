...
if (!dbConfig.tinglebot) {
  console.error('[database-bot.js]: ⚠️  Warning: Database configuration is incomplete. Tinglebot database URI not found.');
  console.error('[database-bot.js]: Please set one of: MONGODB_TINGLEBOT_URI_PROD, MONGODB_TINGLEBOT_URI, or MONGODB_URI');
...
if (!dbConfig.inventories) {
  console.warn('[database-bot.js]: Warning: MONGODB_INVENTORIES_URI_PROD not set. Inventories database features will be unavailable.');
}

if (!dbConfig.vending) {
  console.warn('[database-bot.js]: Warning: MONGODB_VENDING_URI_PROD not set. Vending database features will be unavailable.');
}
