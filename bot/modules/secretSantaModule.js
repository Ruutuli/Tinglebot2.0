...
//   if (deadlineCheckInterval !== null) {
//     clearInterval(deadlineCheckInterval);
//     logger.info('SECRET_SANTA', '[secretSantaModule.js] Cleared existing deadline check interval');
//   }
//   if (blacklistInitTimeout !== null) {
//     clearTimeout(blacklistInitTimeout);
//     logger.info('SECRET_SANTA', '[secretSantaModule.js] Cleared existing blacklist init timeout');
//   }
//   if (startupCheckTimeout !== null) {
//     clearTimeout(startupCheckTimeout);
//     logger.info('SECRET_SANTA', '[secretSantaModule.js] Cleared existing startup check timeout');
//   }

//   // Initialize blacklist on startup (after a delay to ensure MongoDB is ready)
//   blacklistInitTimeout = setTimeout(async () => {
//     try {
//       await initializeBlacklist();
//     } catch (error) {
//       logger.error('SECRET_SANTA', 'Error initializing blacklist on startup:', error);
//     }
//     blacklistInitTimeout = null; // Clear reference after execution
...
//     }
//     startupCheckTimeout = null; // Clear reference after execution
//   }, 10000); // 10 seconds after startup
// }

// // ------------------- Function: cleanupSecretSantaTimers -------------------
// function cleanupSecretSantaTimers() {
//   let cleanedCount = 0;
...
//   if (cleanedCount > 0) {
//     logger.info('SECRET_SANTA', `[secretSantaModule.js] Cleaned up ${cleanedCount} timer(s)`);
//   }
