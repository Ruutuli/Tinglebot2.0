...
const { connectToTinglebot, connectToInventories } = require('./database/db-bot');
  ...
  try {
    ...
    client.on("guildMemberRemove", async (member) => {
      try {
        ...
        const { connectToVending } = require('./database/db-bot');
        ...
        const { deleteCharacterInventoryCollection } = require('./database/db-bot');
