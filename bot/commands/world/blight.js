...
const { fetchCharacterByNameAndUserId, getCharacterBlightHistory } = require('@app/shared/database/db.js');
const { getModCharacterByName } = require('../../modules/modCharacters');
const { retrieveBlightRequestFromStorage } = require('@app/shared/utils/storage');
