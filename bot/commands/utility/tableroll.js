...
const { connectToTinglebot, fetchCharacterByNameAndUserId, fetchItemByName } = require('@app/shared/database/db');
...
const { safeAppendDataToSheet, extractSpreadsheetId, isValidGoogleSheetsUrl, authorizeSheets } = require('@app/shared/utils/googleSheetsUtils');
const { DEFAULT_IMAGE_URL } = require('../../embeds/embeds.js');
const { 
  validateTableName, 
  parseCSVData
} = require('@app/shared/utils/tableRollUtils');
