...
const { connectToTinglebot, fetchCharacterByNameAndUserId, getCharacterInventoryCollection, fetchItemByName } = require('@app/shared/database/db');
...
// ------------------- Utility Functions -------------------
const { addItemInventoryDatabase, processMaterials } = require('@app/shared/utils/inventoryUtils');
...
const { appendSheetData, authorizeSheets } = require('@app/shared/utils/googleSheetsUtils');
