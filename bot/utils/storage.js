 ...
 try {
  ...
  const submission = {
   ...
   data: {
    ...
    boostEffects: submissionData.boostEffects,
    boostTokenIncrease: submissionData.boostTokenIncrease,
    boostFulfillmentTargets: submissionData.boostFulfillmentTargets,
    boostMetadata: submissionData.boostMetadata,
    messageUrl: submissionData.messageUrl,
    embedSent: submissionData.embedSent,
